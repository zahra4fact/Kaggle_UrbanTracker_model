...
LEARNING_RATE = 0.001
EPOCHS = 10
MODEL_DEST_PATH = ROOT_PATH + "models/resnet50_imagenet_pretrained_urban_traffic_dropout_nor.h5"
HIST_DEST_PATH = ROOT_PATH + "references/trainings/resnet50_imagenet_pretrained_urban_traffic_history_dropout_nor"
